...
fn render_html_grid(results: &[CalculationResult], context: BatchSheetContext<'_>) -> String {
  ...
  .cell { border: 1px dashed #999; padding: 10mm 9mm 16mm 9mm; box-sizing: border-box; overflow: hidden; position: relative; font-size: 19px; line-height: 1.7; }
  .cell.wide { grid-row: span 2; }
  .vat { font-size: 36px; font-weight: bold; line-height: 1.2; margin-bottom: 8px; }
  .meta-line { font-size: 22px; margin-bottom: 6px; }
  .divider { border: 0; border-top: 1.8px solid #1f1f1f; margin: 22px 0 22px; }
  .dye-row { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; padding: 6px 0; font-size: 20px; }
  ...
  .yarn-row { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; font-size: 22px; margin-bottom: 6px; }
